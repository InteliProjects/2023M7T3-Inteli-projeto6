...
## Grupo 6 - Solução "Talk to Watson"
...
* 0.3.0 - 06/09/2023
    * Terceira entrega (sprint 3): Wireframe e protótipo, webhooks e sistema de mensageria.
* 0.2.0 - 25/08/2023
    * Segunda entrega (sprint 2): Algoritmo de NLP, construção de APIs e estrutura inicial do backend.
* 0.1.0 - 11/08/2023
    * Primeira entrega (sprint 1): Análise de negócios, Análise de design e Arquitetura inicial do sistema.
* 0.0.0 - 31/07/2023
    * Template Inicial.
